        ...
        <div class="container mx-auto px-4 lg:px-24 py-10 overflow-auto flex justify-center items-center ">
                ...
                @endif
                        ...
                        <section class="">
                            ...
                            mb-3 font-bold uppercase tracking-widest">{{ __('Edit Category') }}</p>
                            <hr/>
                ...
                <form action="{{route('category.update',$category->id)}}" method="POST" >
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="category" class="block mt-1 w-full" type="text" name="category" value="{{$category->category}}" autofocus autocomplete="category" />
