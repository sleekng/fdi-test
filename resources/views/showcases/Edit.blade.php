        ...
        <div class="container mx-auto px-4 lg:px-24 py-10 overflow-auto flex justify-center items-center ">
                ...
                @if (session('errorimage'))
                 ...
                 @endif
                        ...
                        <section class="">
                            ...
                            mb-3 font-bold uppercase tracking-widest">{{ __('Edit Showcase') }}</p>
                            <hr/>
                ...
                <form action="{{route('showcase.update',$showcase->id)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="contact" class="block mt-1 w-full" type="text" name="contact" value="{{$showcase->contact}}" autofocus autocomplete="contact" />
                        <x-input-error :messages="$errors->get('contact')" class="mt-2" style="font-size:10px" />
                    </div>      
                    <div class="mt-4">
                    
                        <x-input-label for="location" :value="__('Location')" />
                        <x-text-input id="location" class="block mt-1 w-full" type="text" name="location" value="{{$showcase->location}}" autofocus autocomplete="location" />
                        <x-input-error :messages="$errors->get('location')" class="mt-2" style="font-size:10px" />
                    </div>      
                    
                    <input type="text" name="id" class="hidden" value="{{$showcase->id}}">
                    
                    <div class="mt-4">


                        <x-input-label for="title" :value="__('Title')" />
                        <x-text-input id="title" class="block mt-1 w-full" type="text" name="title" value="{{$showcase->title}}" autofocus autocomplete="title" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="showcase" class="block mt-1 w-full" type="text" name="showcase" value="{{$showcase->showcase}}" autofocus autocomplete="showcase" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="phone" class="block mt-1 w-full" type="text" name="phone" value="{{$showcase->phone}}" autofocus autocomplete="phone" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="address" class="block mt-1 w-full" type="text" name="address" value="{{$showcase->address}}" autofocus autocomplete="address" />
                    ...
                    <div class="mt-4">
                                            ...
                                            <x-text-input id="website" class="block mt-1 w-full" type="text" name="website" value="{{$showcase->website}}" autofocus autocomplete="website" />
                    ...
                    <div class="mt-4">
                        ...
                        <img src="/storage/showcase/logo/{{$showcase->logo}}" class=" w-40" alt="">
                        <input  id="logo" type="file" value="{{$showcase->logo}}" name="logo" class='pb-2 w-full  focus-within:outline-none underline-offset-0 decoration-transparent text border-b border-b-tertiary bg-transparent'>
                        <p>{{$showcase->logo}}</p>
                    ...
                    <div class="mt-4">
                        ...
                        <img src="/storage/showcase/{{$showcase->image_url}}" class=" w-40" alt="">
                        <input  id="image_url" type="file" value="{{$showcase->image_url}}" name="image_url" class='pb-2 w-full  focus-within:outline-none underline-offset-0 decoration-transparent text border-b border-b-tertiary bg-transparent'>
                        <p>{{$showcase->image_url}}</p>
                    ...
                    <div class="mt-4">
                        ...
                        <img src="/storage/showcase/contact/{{$showcase->contact_pic}}" class=" w-40" alt="">
                        <input  id="contact_pic" type="file" value="{{$showcase->picture}}" name="contact_pic" class='pb-2 w-full  focus-within:outline-none underline-offset-0 decoration-transparent text border-b border-b-tertiary bg-transparent'>
                        <p>{{$showcase->contact_pic}}</p>
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="email" class="block mt-1 w-full" type="email" name="email" value="{{$showcase->email}}" autofocus autocomplete="email" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="url" class="block mt-1 w-full" type="text" name="url" value="{{$showcase->url}}" autofocus autocomplete="url" />
                    ...
                    <div class="mt-4">
                        ...
                        <select name="issue_id" id="issue_id" class="pb-2 w-full  focus-within:outline-none underline-offset-0 decoration-transparent border-b border-b-tertiary bg-transparent">
                            ...
                            @foreach ($issues as $key => $issue)
                                <option value="{{ $issue->id }}"  {{ $issue->id == $showcase->issue_id ? 'selected' : '' }}> {{ $issue->issue }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="mt-4">
                        ...
                        <select name="homeslide" id="homeslide" class="pb-2 w-full  focus-within:outline-none underline-offset-0 decoration-transparent border-b border-b-tertiary bg-transparent">
                            ...
                            <option value="true"  {{ $showcase->homeslide== 'true' ? 'selected' : null }}> Yes </option>
                            <option value="no" {{ $showcase->homeslide == 'no' ? 'selected' : null }}> No </option>
                    ...
                    <div class="mt-4">
                        ...
                        <select name="featured" id="featured" class="pb-2 w-full  focus-within:outline-none underline-offset-0 decoration-transparent border-b border-b-tertiary bg-transparent">
                            <option value="" disabled selected> Select</option>
                            <option value="true"  {{ $showcase->featured == 'true' ? 'selected' : null }}> Yes </option>
                            <option value="no" {{ $showcase->featured == 'no' ? 'selected' : null }}> No </option>
                    ...
                    <div class="mt-4">
                        ...
                        <select name="category" id="category" class="pb-2 w-full  focus-within:outline-none underline-offset-0 decoration-transparent border-b border-b-tertiary bg-transparent">
                            ...
                            @foreach ($categories as $key => $category)
                                <option value="{{ $category->category }}"  {{ $category->category == $showcase->category ? 'selected' : '' }}> {{ $category->category }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="mt-4">
                        ...
                        <input  id="issue_year" class="rounded-md p-1 outline-none ring-0 hover:ring-0 w-full " min="1900" max="{{ date('Y') }}" type="number" name="issue_year" value="{{$showcase->issue_year}}" autofocus style="background: rgba(201, 201, 201, 0.123)">
                    ...
                    <div  class="w-full mt-4">
                        ...
                        <div id="message_body"  class=" rounded-lg ">{!! $showcase->content !!}</div>
                    ...
                    <div class="mt-4 flex justify-between">
                        ...
                        <a class=" p-4 bg-primarycolor rounded-md text-white px-12" href="{{route('showcases')}}">Done</a>
...
<!-- Initialize Quill editor -->
 <script>
    ...
    var toolbarOptions = [
            ...
            [{ 'color': ['#43b2fd'] }, { 'background': [] }],          // dropdown with defaults from theme
