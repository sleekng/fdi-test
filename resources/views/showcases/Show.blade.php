...
<body id="team" class=" relative" >
    ...
    <main >
        ...
        <div class="container  lg:p-24 mx-auto bg-primarycolor  " style="background-image: url('/storage/img/fdi/background-3.jpg'); background-repeat: no-repeat; background-position: center; background-size: cover;">
                        ...
                        <div class="container mx-auto text-white pb-10 ">
                            ...
                            <div class="text-center py-4">
                                ...
                                <div class=" flex justify-center relative z-40 mt-4  ">
                                    <a href="http://{{ $showcase->website }}" target="_blank"
                                        class="bg-white {{ $showcase->logo ? '' : 'hidden' }}  w-40 py-2 px-8  overflow-hidden  rounded-md">
                                        <img src="/storage/showcase/logo/{{ $showcase->logo }}" alt="">
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="lg:border mx-auto overflow-hidden bg-white lg:rounded-lg lg:w-5/6">
                        ...
                        <div class=" relative ">
                            <div class="lg:h-[400px] h-full overflow-hidden flex justify-center items-center">
                                <img src="/storage/showcase/{{ $showcase->image_url }}" class="object-center  w-full"
                                    alt="">
                            </div>
                            <div
                                class=" absolute top-0  p-4 text-xl  drop-shadow-lg flex w-full space-x-4 items-center justify-between">

                                <a href="http://{{ $showcase->url }}" target="_blank" class="{{ $showcase->url ? 'block' : 'hidden' }}   text-white flex-center items-center flex">
                            ...
                            <div class="mt-4 flex space-x-2 col-span-8 ">
                                ...
                                <div class=" flex flex-col space-y-2">
                                    ...
                                    <div class=" mt-4 flex ">
                                        ...
                                        <a class="{{ $showcase->url ? 'block' : 'hidden' }} pr-4"
