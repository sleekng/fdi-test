...
<body id="team" class=" relative">
    ...
    <main>
        ...
        <!--Showcases-->
        <section class="investment bg-primarycolor overflow-hidden py-20 w-full relative flex  ">
            <div class=" container px-4 h-full  xl:px-24 mx-auto">
                ...
                <div class=" mb-10 lg:text-center w-full flex flex-col space-y-2 justify-center items-center">
                    ...
                    <p class=" lg:w-1/2 w-full">As well as showcasing locations across America, our platform includes
                        articles by FDI and industrial development officials, providing practical advice and
                ...
                <div class=" lg:px-40 flex justify-between my-8">
                    <span>
                        ...
                        "{{ $issue->issue }} {{ $showcases[0]->issue_year }}"

                    </span>
                    <a href="{{ route('showcases') }}" class=" flex items-center justify-center space-x-2"><i
