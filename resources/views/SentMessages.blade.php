...
<body id="contact" class=" relative"> 
    ...
    <div class=" emag-header pt-10 h-[250px] lg:h-[400px] relative">
        ...
        <div class="container relative mx-auto px-10 py-10 flex items-center w-full h-full justify-center">
            <h1 class="text-white text-center text-2xl uppercase md:text-2xl border-b"> <span class="font-bold ">Sent Messages</h1>
        </div>
    </div>
    <main>
                ...
                <div class=" h-full w-full lg:w-[600px] rounded-xl bg-white xl:p-12  relative">
                  ...
                  <div class="overflow-y-auto  p-4 custom-scrollbar h-full overflow-x-hidden ">
                    <div class=" mt-4 ">
                        ...
                        <span class="font-bold border-b block">  {{ session('view-message')['to'] }}</span>
                    </div>
                    <div class=" mt-4">
                       <span class=" font-bold border-b block"> {{ session('view-message')['subject'] }}</span>
                    </div>
                    <div class=" mt-4">
                            ...
                            <tr>
                                <td class="border  text-[12px] px-4 py-4  w-[100px] text-center">{{ $index + 1 }}</td>    
                                    <td class="border  text-[12px] px-4 py-4 text-center  ">
                                     @if ( $sentmessage['to']  == 'newsletter-subscribers')
                                      <a href="" class=" font-bold">Newsletter Subscribers</a>

                                      @elseif($sentmessage['to']  == 'media-kit')
                                      <a href="" class=" font-bold">MediaKit Request</a>
                                      
                                      @elseif($sentmessage['to']  == 'magazine-subscribers')
                                      <a href="" class=" font-bold">Magazine Subscribers</a>

                                      @else
                                     
                                        <a href="" class=" font-bold"> {{$sentmessage['to']}}</a>
                                       @endif
                                    </td>
                                    <td class="border  text-[12px] px-4 py-4 text-center  ">{{ $sentmessage['subject'] }}</td>
                                    ...
                                    <td class="border text-[12px]  px-4 py-4 text-center  ">
                                      ...
                                      <td class="border text-[12px]  px-4 py-4 text-center   max-w-[100px] ">
                                        <a href="{{route('sent-messages.show', $sentmessage['id'] )}}" class=" text-secondarycolor">
                                            View
                                        </a> 
