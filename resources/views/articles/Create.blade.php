        ...
        <div class="container mx-auto px-4 lg:px-24 py-10 overflow-auto flex justify-center items-center ">
                ...
                <form action="{{route('article-store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="author" class="block mt-1 w-full" type="text" name="author" :value="old('author')" autofocus autocomplete="author" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="article" class="block mt-1 w-full" type="text" name="article" :value="old('article')" autofocus autocomplete="article" />
                    ...
                    <div class="mt-4">
                        ...
                        <input  id="picture" type="file" name="picture" class='pb-2 w-full  focus-within:outline-none underline-offset-0 decoration-transparent text border-b border-b-tertiary bg-transparent'>
