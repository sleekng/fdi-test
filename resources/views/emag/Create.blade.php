            ...
            @if (session('errorimage'))
             ...
             @endif
                        ...
                        <section class="">
                            ...
                            mb-3 font-bold uppercase tracking-widest">{{ __('Create New Article') }}</p>
                            <hr/>

                        </section>
 
                
                <form action="{{route('emagazine-store')}}" method="POST" enctype="multipart/form-data">
                    @csrf

                    <div class="mt-4">
                    
                        <x-input-label for="e_position" :value="__('Magazine Position')" />
                        <x-text-input id="e_position" class="block mt-1 w-full" type="number" min="1" name="e_position" :value="old('e_position')" autofocus autocomplete="e_position" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="e_header" class="block mt-1 w-full" type="text" name="e_header" :value="old('e_header')" autofocus autocomplete="e_header" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="e_url" class="block mt-1 w-full" type="url" name="e_url" :value="old('e_url')" autofocus autocomplete="e_url" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="e_sponsor" class="block mt-1 w-full" type="text" name="e_sponsor" :value="old('e_sponsor')" autofocus autocomplete="e_sponsor" />
                    ...
                    <div class="mt-4">
                        ...
                        <input  id="e_front" type="file" name="e_front" class='pb-2 w-full  focus-within:outline-none underline-offset-0 decoration-transparent text border-b border-b-tertiary bg-transparent'>
                    ...
                    <div class="mt-4">
                        ...
                        <input  id="e_back" type="file" name="e_back" class='pb-2 w-full  focus-within:outline-none underline-offset-0 decoration-transparent text border-b border-b-tertiary bg-transparent'>
                    ...
                    <div class="mt-4">
                        ...
                        <x-input-label for="issue_id" :value="__(' Magazine Issue')" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-input-label for="issue_year" :value="__(' Magazine Issue Year')" />
                    ...
                    <div  class="w-full mt-4">
                        ...
                        <div id="e_body"  class=" rounded-lg "></div>
                        <textarea value="{{ old('e_body') }}" name="e_body" id="editor-content" style="display:none;"></textarea>
