        ...
        <div class="container mx-auto px-4 lg:px-24 py-10 overflow-auto flex justify-center items-center ">
                ...
                @endif
                        ...
                        <section class="">
                            ...
                            mb-3 font-bold uppercase tracking-widest">{{ __('Create New Issue') }}</p>
                            <hr/>
                ...
                <form action="{{route('issue.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="issue" class="block mt-1 w-full" type="text" name="issue" :value="old('issue')" autofocus autocomplete="issue" />
