...
let $elmt = $(".vegasslider").vegas({
    ...
    slides: [
       { src: "storage/img/clients-bg/tomball.jpg" },
       { src: "storage/img/clients-bg/beach.jpg" },
       { src: "storage/img/clients-bg/arizona.JPG" },
       { src: "storage/img/clients-bg/hunthinton.jpg" },
